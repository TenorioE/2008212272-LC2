...
namespace PaqueteTuristico.MVC.Controllers
{
    public class AlimentacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServicioTuristicoId,Fecha,Hora,Direccion,CategoriaAlimentacion")] Alimentacion alimentacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServicioTuristicoId,Fecha,Hora,Direccion,CategoriaAlimentacion")] Alimentacion alimentacion)
        {
            if (ModelState.IsValid)
            {
