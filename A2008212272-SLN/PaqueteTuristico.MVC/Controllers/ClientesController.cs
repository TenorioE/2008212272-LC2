...
namespace PaqueteTuristico.MVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonaId,Nombres,ApePat,ApeMat,email,Celular,Direccion,Dni,NroTarjeta")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonaId,Nombres,ApePat,ApeMat,email,Celular,Direccion,Dni,NroTarjeta")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
