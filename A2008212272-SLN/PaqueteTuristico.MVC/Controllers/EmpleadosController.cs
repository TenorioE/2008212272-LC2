...
namespace PaqueteTuristico.MVC.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonaId,Nombres,ApePat,ApeMat,email,Celular,Direccion,Dni,Sueldo")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonaId,Nombres,ApePat,ApeMat,email,Celular,Direccion,Dni,Sueldo")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
