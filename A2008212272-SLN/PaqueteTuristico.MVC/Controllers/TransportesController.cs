...
namespace PaqueteTuristico.MVC.Controllers
{
    public class TransportesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServicioTuristicoId,Fecha,Hora,Direccion,DescripcionTransporte,TipoTransporte,CategoriaTransporte")] Transporte transporte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServicioTuristicoId,Fecha,Hora,Direccion,DescripcionTransporte,TipoTransporte,CategoriaTransporte")] Transporte transporte)
        {
            if (ModelState.IsValid)
            {
