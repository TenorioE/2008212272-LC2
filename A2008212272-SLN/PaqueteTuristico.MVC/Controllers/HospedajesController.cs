...
namespace PaqueteTuristico.MVC.Controllers
{
    public class HospedajesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServicioTuristicoId,Fecha,Hora,Direccion,Descripcion,TipoHospedaje,CalificacionHospedaje,CategoriaHospedaje,ServicioHospedaje")] Hospedaje hospedaje)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServicioTuristicoId,Fecha,Hora,Direccion,Descripcion,TipoHospedaje,CalificacionHospedaje,CategoriaHospedaje,ServicioHospedaje")] Hospedaje hospedaje)
        {
            if (ModelState.IsValid)
            {
