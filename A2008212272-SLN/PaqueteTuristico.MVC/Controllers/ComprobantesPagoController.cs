...
namespace PaqueteTuristico.MVC.Controllers
{
    public class ComprobantesPagoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ComprobantePagoId,Descripcion,TipoComprobante")] ComprobantePago comprobantePago)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ComprobantePagoId,Descripcion,TipoComprobante")] ComprobantePago comprobantePago)
        {
            if (ModelState.IsValid)
            {
